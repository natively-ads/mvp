...
ALTER TABLE "public"."advertisers" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."advertisers_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."advertisers"
    ADD CONSTRAINT "advertisers_id_key" UNIQUE ("id");
...
GRANT ALL ON SEQUENCE "public"."advertisers_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."advertisers_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."advertisers_id_seq" TO "service_role";
